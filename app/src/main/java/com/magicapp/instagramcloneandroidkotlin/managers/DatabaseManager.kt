package com.magicapp.instagramcloneandroidkotlin.managers

import android.annotation.SuppressLint
import com.google.firebase.firestore.FirebaseFirestore
import com.magicapp.instagramcloneandroidkotlin.managers.handler.*
        ...
        reference.get().addOnCompleteListener {
            ...
            if (it.isSuccessful) {
                for (document in it.result!!) {
                    ...
                    val fullname = document.getString("fullname")
                    val userImg = document.getString("userImg")
                    var currentDate = document.getString("currentDate")
